                    ...
                    <div class="card text-white bg-gradient-primary">
                        ...
                        <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                            ...
                            <canvas class="chart chartjs-render-monitor" id="card-chart1" height="70"
                                    style="display: block; width: 343px; height: 70px;" width="343"></canvas>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-white bg-gradient-info">
                        ...
                        <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                            ...
                            <div id="card-chart2-tooltip" class="c-chartjs-tooltip top"
                                 style="opacity: 0; left: 243.681px; top: 95.586px;">
                                ...
                                <div class="c-tooltip-body">
                                    <div class="c-tooltip-body-item"><span class="c-tooltip-body-item-color"
                                                ...
                                                class="c-tooltip-body-item-value">34</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card text-white bg-gradient-warning">
                        ...
                        <div class="c-chart-wrapper mt-3" style="height:70px;">
                            ...
                            <canvas class="chart chartjs-render-monitor" id="card-chart3" height="70"
                                    style="display: block; width: 375px; height: 70px;" width="375"></canvas>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                            ...
                            <button class="btn btn-primary" type="button">
                                <svg class="c-icon">
                                    <use xlink:href="<?= $bundleBaseUrl; ?>free.svg#cil-cloud-download"></use>
                                </svg>
                            </button>
                        </div>
                    </div>
                    <div class="c-chart-wrapper" style="height:300px;margin-top:40px;">
                        ...
                        <canvas class="chart chartjs-render-monitor" id="main-chart" height="300"
                                style="display: block; width: 1548px; height: 300px;" width="1548"></canvas>
                        <div id="main-chart-tooltip" class="c-chartjs-tooltip center"
                             style="opacity: 0; left: 613.256px; top: 190.093px;">
                            <div class="c-tooltip-header">
                    ...
                    <div class="card">
                        <div class="card-header bg-facebook content-center">
                            <svg class="c-icon c-icon-3xl text-white my-4">
                                <use xlink:href="<?= $bundleBaseUrl; ?>brand.svg#cib-facebook-f"></use>
                            </svg>
                        </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <div class="card-header bg-twitter content-center">
                            <svg class="c-icon c-icon-3xl text-white my-4">
                                <use xlink:href="<?= $bundleBaseUrl; ?>brand.svg#cib-twitter"></use>
                            </svg>
                        </div>
                        <div class="card-body row text-center">
                            <div class="col">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <div class="card-header bg-linkedin content-center">
                            <svg class="c-icon c-icon-3xl text-white my-4">
                                <use xlink:href="<?= $bundleBaseUrl; ?>brand.svg#cib-linkedin"></use>
                            </svg>
                        </div>
                        <div class="card-body row text-center">
                            <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="progress-group mb-5">
                                        <div class="progress-group-header">
                                            <svg class="c-icon progress-group-icon">
                                                <use xlink:href="<?= $bundleBaseUrl; ?>free.svg#cil-user-female"></use>
                                            </svg>
                                            <div>Female</div>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header align-items-end">
                                            <svg class="c-icon progress-group-icon">
                                                <use xlink:href="<?= $bundleBaseUrl; ?>brand.svg#cib-google"></use>
                                            </svg>
                            ...
                            <table class="table table-responsive-sm table-hover table-outline mb-0">
                                ...
                                <tr>
                                    <th class="text-center">
                                        <svg class="c-icon">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>free.svg#cil-people"></use>
                                        </svg>
                                    </th>
                                    <th>User</th>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="c-avatar"><img class="c-avatar-img" src="/img/example/1.jpg"
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>flag.svg#cif-us"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>brand.svg#cib-cc-mastercard"></use>
                                        </svg>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="c-avatar"><img class="c-avatar-img" src="/img/example/2.jpg"
                                                                   alt="user@email.com"><span
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>flag.svg#cif-br"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>brand.svg#cib-cc-visa"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="small text-muted">Last login</div>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="c-avatar"><img class="c-avatar-img" src="/img/example/3.jpg"
                                                                   alt="user@email.com"><span
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>flag.svg#cif-in"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>brand.svg#cib-cc-stripe"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="small text-muted">Last login</div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>flag.svg#cif-fr"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>brand.svg#cib-cc-paypal"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="small text-muted">Last login</div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>flag.svg#cif-es"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>brand.svg#cib-cc-apple-pay"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="small text-muted">Last login</div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>flag.svg#cif-pl"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="clearfix">
                                    ...
                                    <td class="text-center">
                                        <svg class="c-icon c-icon-xl">
                                            <use xlink:href="<?= $bundleBaseUrl; ?>brand.svg#cib-cc-amex"></use>
                                        </svg>
                                    </td>
                                    <td>
                                        <div class="small text-muted">Last login</div>
