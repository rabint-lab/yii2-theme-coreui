...
<div class="c-sidebar c-sidebar-lg c-sidebar-light c-sidebar-right c-sidebar-overlaid" id="aside">
    <button class="c-sidebar-close c-class-toggler" type="button" data-target="_parent" data-class="c-sidebar-show"
            responsive="true">
        <svg class="c-icon">
            <use xlink:href="<?= $bundleBaseUrl; ?>free.svg#cil-x"></use>
        </svg>
    </button>
    <ul class="nav nav-tabs nav-underline nav-underline-primary" role="tablist">
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">
                <svg class="c-icon">
                    <use xlink:href="<?= $bundleBaseUrl; ?>free.svg#cil-list"></use>
                </svg>
            </a></li>
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#messages" role="tab">
                <svg class="c-icon">
                    <use xlink:href="<?= $bundleBaseUrl; ?>free.svg#cil-speech"></use>
                </svg>
            </a></li>
        ...
        <div class="tab-pane active" id="timeline" role="tabpanel">
            <div class="list-group list-group-accent">
                ...
                <div class="list-group-item list-group-item-accent-warning list-group-item-divider">
                    <div class="c-avatar float-right"><img class="c-avatar-img" src="/img/example/7.jpg"
                                                           alt="user@email.com"></div>
                    <div>Meeting with <strong>Lucas</strong></div>
                    <small class="text-muted mr-3">
                        <svg class="c-icon">
                            <use xlink:href="<?= $bundleBaseUrl; ?>free.svg#cil-calendar"></use>
                        </svg>&nbsp; 1 - 3pm</small><small class="text-muted">
                        <svg class="c-icon">
                            <use xlink:href="<?= $bundleBaseUrl; ?>free.svg#cil-location-pin"></use>
                        </svg>&nbsp; Palo Alto, CA</small>
                </div>
                <div class="list-group-item list-group-item-accent-info">
                    <div class="c-avatar float-right"><img class="c-avatar-img" src="/img/example/4.jpg"
                                                           alt="user@email.com"></div>
                    ...
                    <small class="text-muted mr-3">
                        ...
                        <svg class="c-icon">
                            <use xlink:href="<?= $bundleBaseUrl; ?>free.svg#cil-skype"></use>
                        </svg>&nbsp; On-line</small>
                </div>
                <div class="list-group-item list-group-item-accent-secondary bg-light text-center font-weight-bold text-muted text-uppercase c-small">
                    Tomorrow
                ...
                <div class="list-group-item list-group-item-accent-danger list-group-item-divider">
                    ...
                    <small class="text-muted mr-3">
                        ...
                        <svg class="c-icon">
                            <use xlink:href="<?= $bundleBaseUrl; ?>free.svg#cil-home"></use>
                        </svg>&nbsp; creativeLabs HQ</small>
                    <div class="c-avatars-stack mt-2">
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="/img/example/2.jpg"
                                                               alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="/img/example/3.jpg"
                                                               alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="/img/example/4.jpg"
                                                               alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="/img/example/5.jpg"
                                                               alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="/img/example/6.jpg"
                                                               alt="user@email.com"></div>
                    </div>
                </div>
                ...
                <div class="list-group-item list-group-item-accent-primary list-group-item-divider">
                    ...
                    <div class="c-avatars-stack mt-2">
                        ...
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="/img/example/6.jpg"
                                                               alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="/img/example/7.jpg"
                                                               alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="/img/example/8.jpg"
                                                               alt="user@email.com"></div>
                    </div>
                </div>
            </div>
